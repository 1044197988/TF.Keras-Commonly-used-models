...
def lovasz_softmax(labels, probas, classes='present', per_image=False, ignore=None, order='BHWC'):
    ...
    if per_image:
        ...
        y_true,y_pred = flatten_probas(labels, probas, ignore, order)
        loss = lovasz_softmax_flat(y_true, y_pred, classes=classes)
    return loss
...
def flatten_probas(labels, probas, ignore=None, order='BHWC'):
    """
